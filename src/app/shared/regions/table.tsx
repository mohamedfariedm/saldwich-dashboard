...
export default function RegionsTable({     text_tr,  permitions,
  data = [], getSelectedColumns, getSelectedRowKeys, totalItems }: {text_tr?:any,  permitions?: string[],    data: any[], getSelectedColumns: React.Dispatch<React.SetStateAction<any[]>>, getSelectedRowKeys: React.Dispatch<React.SetStateAction<any[]>>, totalItems: number }) {
