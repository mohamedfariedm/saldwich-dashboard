...
export const getColumns = ({
  ...
  },
  {
      ...
      render: (_: string, row: any) => (
        ...
        {permitions?.includes("edit_region")?  <Tooltip
            size="sm"
         ...
         {permitions?.includes("delete_region")? <DeletePopover
            title={`Delete region`}
  ...
  {
    title: <HeaderCell title={text_tr.regions.regionname}/>,
    dataIndex: 'name',
    key: 'name',
    width: 300,
    hidden: 'name',
  ...
  {
    title: <HeaderCell title={text_tr.regions.active} />,
    dataIndex: 'is_active',
    key: 'is_active',
    width: 30,
    hidden: 'is_active',
