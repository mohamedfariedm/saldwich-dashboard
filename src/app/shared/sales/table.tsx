...
export default function SalesTable({text_tr, data = [], setSelectedColumns, getSelectedRowKeys,totalItems }: {text_tr:any, data: any[], setSelectedColumns: React.Dispatch<React.SetStateAction<any[]>>, getSelectedRowKeys: React.Dispatch<React.SetStateAction<any[]>>,totalItems: number }) {
