...
export default function SimpleBarChart({text_tr, className, details,stat }: {text_tr?:any, className?: string; details?: any,stat?:number }) {
  ...
  const filterState = {
    ...
    user_id: params.get('promoter_id') || '',
  ...
  const viewTypesOptions = [
    ...
    {
      value: 'stores',
      name: text_tr.sold_qty.stores,
    },
    {
      value: 'promoters',
      name: text_tr.sold_qty.promoters,
    },
    {
      name: text_tr.sold_qty.downloadbtn
    },
    {
      name: text_tr.sold_qty.view
    },
    {
      suptitle:text_tr.sold_qty.suptitle,
     
      sup:text_tr.sold_qty.sup,
  ...
  return (
    ...
    >
      <div className="mt-4 flex items-center gap-3 @lg:mt-0">
          ...
          <TicketActivity viewOption={viewTypesOptions} name={params.get('chart_for') || 'stores'} data={details}/>
