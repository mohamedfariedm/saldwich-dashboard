...
import { useCreatepartners, useUpdatepartners } from '@/framework/partners';
...
export default function UpdateCreateBrand({
  ...
  const { mutate: update } = useUpdatepartners();
  const { mutate: create, isPending } = useCreatepartners();
            ...
            <>
              <div className="flex items-center justify-between">
                <Title as="h4" className="font-semibold">
                  {initValues ? 'Update Partner' : 'Add a new Partner'}
                </Title>
              ...
              <div className="flex items-center justify-end gap-4">
                ...
                <Button
                  ...
                  className="w-full @xl:w-auto"
                >
                  {initValues ? 'Update Partner' : 'Create Partner'}
                </Button>
              </div>
            </>
          );
