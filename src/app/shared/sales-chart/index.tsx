...
export default function SimpleBarChart({text_tr ,className, details }: {text_tr?:any, className?: string; details: any }) {
  ...
  const viewOptions = [
    {
      value: 'yearly',
      name: text_tr.sales_chart.yearly,
    },
    {
      value: 'quarter',
      name: text_tr.sales_chart.quarter,
    },
    {
      value: 'monthly',
      name: text_tr.sales_chart.monthly,
    },
    {
      value: 'weekly',
      name: text_tr.sales_chart.weekly
    },
  ];
  ...
  const viewTypesOptions = [
    ...
    {
      value: 'stores',
      name: text_tr.sales_chart.stores,
    },
    {
      value: 'promoters',
      name: text_tr.sales_chart.promoters,
    },
  ...
  useEffect(() => {
    if(details?.sales){
      setData(details?.sales?.map((item: any) => ({
            key: formatLabel(params.get('type') || 'yearly' ,item?.label),
    ...
    >
      ...
      <WidgetCard
        ...
        >
          ...
          {text_tr.sales_chart.downloadbtn}
        </Button>
          </div>
        }
        className={className}
...
function Legend({ className ,text}: {text:any, className?: string }) {
  return (
