...
export default function NewInstalledSoftPOSMTable({  text_tr, data = [],totalItems, setSelectedColumns, getSelectedRowKeys }: {text_tr?:any, data: any[], totalItems:number, setSelectedColumns: React.Dispatch<React.SetStateAction<any[]>>, getSelectedRowKeys: React.Dispatch<React.SetStateAction<any[]>> }) {
  ...
  const filterState = {
    ...
    installationDateFrom_from: params.get('installationDateFrom_from') || '',
    installationDateFrom_to: params.get('installationDateFrom_to') || '',
    installationDateTo_from: params.get('installationDateTo_from') || '',
    installationDateTo_to: params.get('installationDateTo_to') || '',
    ...
    have_permanent_promoters: params.get('have_permanent_promoters') || '',
  };
  useEffect(() => {
