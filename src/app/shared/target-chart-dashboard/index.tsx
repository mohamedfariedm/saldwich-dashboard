...
const FilterElement = dynamic(
  () => import('@/app/shared/target-chart-dashboard/filter-element'),
  { ssr: false }
);
  ...
  return (
    ...
    >
      <div className="mt-4 flex items-center gap-3 @lg:mt-0">
          ...
          <MixBarChart text={text_tr} colorkey={color[1]} name={params.get('group_by') || 'retailers'} data={details} role={1}  />
