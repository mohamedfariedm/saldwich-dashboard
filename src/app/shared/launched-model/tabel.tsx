...
export default function LaunchedModelTable({text_tr, data = [],totalItems, setSelectedColumns, getSelectedRowKeys }: {text_tr:any, data: any[],totalItems:number ,setSelectedColumns: React.Dispatch<React.SetStateAction<any[]>>, getSelectedRowKeys: React.Dispatch<React.SetStateAction<any[]>> }) {
