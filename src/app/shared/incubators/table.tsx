...
import { getColumns } from '@/app/shared/incubators/columns';
import ControlledTable from '@/components/controlled-table';
import { Text } from '@/components/ui/text';
import { useDeleteIncubators } from '@/framework/incubators';
...
export default function BrandTable({
  ...
  const { mutate: deleteBrand } = useDeleteIncubators(PreviousIncubators);
