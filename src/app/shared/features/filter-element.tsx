    ...
    <>
      ...
      <div className='w-full'>
        ...
        closeMenuOnSelect={true}
          ...
          value={filters['category_id']?{label:categoriesName?.find((option) => option.value === filters['category_id'])?.label,value:filters['category_id']}:""}
          styles={{
          ...
          placeholder='Selelct BG'
          onChange={(value: any) => {
            updateFilter('category_id', value.value);
          }}
        />
      </div>
<div className='w-full'>
