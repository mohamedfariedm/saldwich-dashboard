...
export const getColumns = ({
  ...
  },
  {
      ...
      render: (_: string, row: any) => (
        <div className="flex items-center gap-3">
          {permitions?.includes("edit_feature")?<Tooltip
            size="sm"
         ...
         {permitions.includes("delete_feature")? <DeletePopover
            title={`Delete region`}
  ...
  {
    title: <HeaderCell title={text_tr.features.featuresName} />,
    dataIndex: 'name',
    key: 'name',
    width: 300,
    hidden: 'name',
  ...
  {
    title: <HeaderCell title={text_tr.features.active} />,
    dataIndex: 'is_active',
    key: 'is_active',
    width: 30,
    hidden: 'is_active',
  ...
  },
  {
    title: (
      <HeaderCell
        title={text_tr.features.created}
        sortable
        ascending={
