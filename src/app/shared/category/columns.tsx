...
import CategoreyForm from './form';
...
export const getColumns = ({
      ...
      <div className="flex items-center gap-3">
        ...
        >
          <CreateButton
            ...
            view={<CategoreyForm initValues={row} />}
            label=""
  ...
  {
    title: <HeaderCell align="center" title={'show in homepage'} />,
    dataIndex: 'show_in_homepage',
    key: 'show_in_homepage',
    width: 150,
    hidden: 'show_in_homepage',
    render: (_: string, row: any) => (
      <div className="w-full  text-center">
        {row?.show_in_homepage ? 'Show' : 'Hidden'}
      </div>
    ),
  },
  {
