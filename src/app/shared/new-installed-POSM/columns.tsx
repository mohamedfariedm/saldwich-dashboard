...
export const getColumns = ({
  ...
  {
    title: <HeaderCell title={text_tr.NewInstalledPOSM_report.username}/>,
    dataIndex: 'user.name',
    key: 'username',
    width: 100,
    hidden: 'username',
  ...
  {
    title: <HeaderCell title={text_tr.NewInstalledPOSM_report.region}/>,
  ...
  {
    title: <HeaderCell title={text_tr.NewInstalledPOSM_report.city}/>,
  ...
  {
    title: <HeaderCell title={text_tr.NewInstalledPOSM_report.retailer} />,
  ...
  {
    title: <HeaderCell title={text_tr.NewInstalledPOSM_report.storename} />,
  ...
  {
    title: <HeaderCell title={text_tr.NewInstalledPOSM_report.brand} />,
  ...
  {
    title: <HeaderCell title={text_tr.NewInstalledPOSM_report.bg}  />,
  ...
  {
    title: <HeaderCell title={text_tr.NewInstalledPOSM_report.vcp}  />,
  ...
  {
    title: <HeaderCell title={text_tr.NewInstalledPOSM_report.bu}  />,
  ...
  {
    title: <HeaderCell title={text_tr.NewInstalledPOSM_report.height}  />,
    dataIndex: 'H_value',
    key: 'Height',
    width: 30,
    hidden: 'Height',
  ...
  {
    title: <HeaderCell title={text_tr.NewInstalledPOSM_report.width}/>,
    dataIndex: 'W_value',
    key: 'Width',
    width: 30,
    hidden: 'Width',
  ...
  {
    title: <HeaderCell title={text_tr.NewInstalledPOSM_report.length} />,
    dataIndex: 'L_value',
    key: 'Length',
    width: 30,
    hidden: 'Length',
  ...
  {
    title: <HeaderCell title={text_tr.NewInstalledPOSM_report.depth}  />,
    dataIndex: 'D_value',
    key: 'Depth',
    width: 30,
    hidden: 'Depth',
  ...
  
  {
    title: (
      <HeaderCell
        title={text_tr.NewInstalledPOSM_report.installation} 
        sortable
        ascending={
  ...
  },
  {
    title: (
      <HeaderCell
        title={text_tr.NewInstalledPOSM_report.removedate} 
        sortable
        ascending={
