...
import {
    CategoryFormInput,
    CategoryFormSchema,
} from '@/utils/validators/category-form-sup-sup.schema';
        ...
        {isCategoriesLoading ? (
            ...
            <Form<CategoryFormInput>
                ...
                useFormProps={{
                    ...
                    //@ts-ignore
                    grand_parent_category:initValues?{value:allProdCreate?.data?.categories?.find((r: any) => r.name === initValues?.BG)?.id,label:initValues?.BG}:"",
                    //@ts-ignore
                    parent_category:initValues?{value:allProdCreate?.data?.categories?.find((cat: any) => cat?.name == initValues?.BG)?.children?.find((r: any) => r.name == initValues?.VCP)?.id,label:initValues?.VCP}:"",
                    }
                }}
                ...
                {({ register, getValues, setValue, control,watch , formState: { errors } }) => {
                    ...
                    <>
                        ...
                        <FormGroup
                            ...
                            <Controller
                                ...
                                styles={{
                                    control: (baseStyles, state) => ({
                                      ...baseStyles,
                                      boxShadow:"",
                                      borderColor:`${errors?.grand_parent_category?.message ?"red":"none"}`,
                            ...
                            />
                            <span className="text-red text-xs mt-0.5 rizzui-input-error-text">{errors?.grand_parent_category?.message ?"is Required":""}</span>
                        </FormGroup>
