...
import { forgetPasswordSchema, ForgetPasswordSchema } from '@/utils/validators/forget-password-by-phone.schema';
import { useMedia } from 'react-use';
import toast from 'react-hot-toast';
import { useGetPhone } from '@/framework/auth';
...
export default function ForgetPasswordForm() {
  ...
  const { mutate: phoneNum,isPending } = useGetPhone();
