...
import { forgetPasswordSchema, ForgetPasswordSchema } from '@/utils/validators/forget-password-by-verification';
import { useMedia } from 'react-use';
import toast from 'react-hot-toast';
import { useGetCode } from '@/framework/auth';
...
export default function ForgetPasswordForm() {
  ...
  const { mutate: code,isPending } = useGetCode();
