  ...
  return (
    <>
        ...
        closeMenuOnSelect={true}
          options={userDetails}
          value={filters['id']?{label:userDetails?.find((option) => option.value === filters['id'])?.label,value:filters['id']}:""}
          styles={{
        ...
        <div className='w-full'>
          ...
          <DateFiled
            ...
            onChange={(date: any) => {
            updateFilter('date', formatDate(new Date(date), 'YYYY-MM-DD'));
            }}
